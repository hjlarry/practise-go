...
var fileDescriptor_61ef911816e0a8ce = []byte{
	...
	0x35, 0xaa, 0x81, 0x9a, 0x15, 0x9c, 0x5a, 0x54, 0x96, 0x99, 0x9c, 0x2a, 0x64, 0xc8, 0xc5, 0x0a,
	0xe6, 0x0b, 0x09, 0x43, 0xec, 0xd4, 0x43, 0xb6, 0x49, 0x4a, 0x10, 0x55, 0xb0, 0x20, 0xa7, 0x52,
	0x89, 0x41, 0xc8, 0x92, 0x8b, 0x37, 0x38, 0xb1, 0x12, 0x2c, 0xe4, 0x98, 0x9e, 0x98, 0x99, 0x47,
	0xbc, 0xd6, 0x24, 0x36, 0xb0, 0x98, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x1a, 0xf0, 0xf2, 0x55,
	0xe6, 0x00, 0x00, 0x00,
}
...
func (c *helloServiceClient) SayHelloAgain(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/proto.HelloService/SayHelloAgain", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedHelloServiceServer) SayHelloAgain(ctx context.Context, req *HelloRequest) (*HelloReply, error) {
...
func _HelloService_SayHelloAgain_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.HelloService/SayHelloAgain",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
